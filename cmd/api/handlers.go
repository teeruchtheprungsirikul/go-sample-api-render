...
func (app *application) Home(w http.ResponseWriter, r *http.Request) {
	...
	var payload = struct {
		...
		Status:  "active",
		Message: "Go Movies up and runnig",
		Version: "1.0.0",
	}
...
func (app *application) AllMovies(w http.ResponseWriter, r *http.Request) {
	// ฟังก์ชันสำหรับแสดงรายชื่อหนังทั้งหมดโดยเรียกจาก database (เรียกจากหน้าบ้าน)
...
func (app *application) MovieCatalog(w http.ResponseWriter, r *http.Request) {
	// MovieCatalog แสดงรายชื่อหนังในแคตตาล็อก (เรียกจากหลังบ้าน)
...
func (app *application) UpdateMovie(w http.ResponseWriter, r *http.Request) {
	...
	// Get Movie before Update Movie
	movie, err := app.DB.OneMovie(payload.ID)
	if err != nil {
		app.errorJSON(w, errors.New("movie not found can't update"), http.StatusNotFound)
		// app.errorJSON(w, err)
		return
	}
