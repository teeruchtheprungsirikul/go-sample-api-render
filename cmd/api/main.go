...
func main() {
	...
	// อ่านค่าจาก enviroment variables
	app.DSN = dsn

	// Read from command line arguments
	// flag.StringVar(&app.DSN, "dsn",
	// 	"host=localhost port=5432 dbname=gosampledb user=postgres password=0845 sslmode=disable timezone=UTC connect_timeout=5",
	// 	"Postgres connection string",
	// )

	// ตั้งค่าตัวแปร JWT จาก enviroment variables
